#include "..\..\header\Parallax\Camada.h"

Fantasy::Parallax::Camada::Camada(const sf::Vector2f tamJanela, sf::Texture textura, const float vel) :
...
Fantasy::Parallax::Camada::~Camada() {

}

void Fantasy::Parallax::Camada::trocarTextura() {
    sf::RectangleShape trocar = fundo;
    fundo = fundoAuxiliar;
    fundoAuxiliar = trocar;
}

void Fantasy::Parallax::Camada::desenharCamada(sf::RenderWindow* window) {
    window->draw(fundo);
    if (vel != 0.0f) {
...
void Fantasy::Parallax::Camada::atualizar(const sf::Vector2f ds, const sf::Vector2f posCameraAtual) {
